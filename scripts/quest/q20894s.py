...
sm.setSpeakerID(1101000)
sm.sendNext("Haha, is that what Neinheart said? It is a recommendation about you. It's all about the process of you getting stronger and the activities done by you...")
sm.setPlayerAsSpeaker()
