...
public class EventManager {
     ...
     * @param delay
     *            The delay (in ms) after which the call should start
     * @param <V>
     *            Return type of the given callable
     ...
     *            The method that should be called
     * @param delay
     *            The delay after which the call should start
     * @param timeUnit
     ...
     * 
     * @param runnable
     *            The method that should be run
     * @param initialDelay
     *            The time that it should take before the first execution should start
     * @param delay
     *            The time it should (in ms) take between the start of execution n and execution n+1
     * @return The created event (ScheduledFuture)
     */
     ...
     *            The time that it should take before the first execution should start
     * @param delay
     *            The time it should take between the start of execution n and execution n+1
     * @param timeUnit
