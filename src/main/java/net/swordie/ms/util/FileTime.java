...
public class FileTime implements Serializable {
     ...
     * 
     * @param time
     *            the long the FileTime should be created from
     */
     ...
     * 
     * @param time
     *            millis since epoch that this FileTime should correspond to
     ...
     * 
     * @param localDateTime
     *            date that this FileTime should correspond to
    ...
    public boolean equals(Object o) {
        ...
        return lowDateTime == fileTime.lowDateTime && highDateTime == fileTime.highDateTime;
    }
    ...
    public String toString() {
        return "FileTime{" + "lowDateTime=" + lowDateTime + ", highDateTime=" + highDateTime + '}';
    }
