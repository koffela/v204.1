...
public class PetHandler {
    ...
    public static void handleUserActivatePetRequest(Client c, InPacket inPacket) {
        ...
        c.write(WvsContext.inventoryOperation(true, false, InventoryOperation.Add, (short) petItem.getBagIndex(), (short) 0, 0, petItem));
        chr.dispose();
    }
    ...
    public static void handleUserPetFoodItemUseRequest(Client c, InPacket inPacket) {
        ...
        if (item != null) {
            ...
            for (Pet pet : chr.getPets()) {
                ...
                c.write(WvsContext.inventoryOperation(true, false, InventoryOperation.Add, (short) pi.getBagIndex(), (short) 0, 0, pi));
            }
        }
    }
