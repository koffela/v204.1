...
public interface ScriptManager extends Observer {
     ...
     * 
     * @param look
     *            the id of the look (skin/eyes/hair) to change
     */
     ...
     * 
     * @param possibleMobs
     *            the ids the mob can have. If multiple ids are given, this will return when there is a single match
     * @return the mob that died
     */
     ...
     *
     * @param npcTemplateId
     *            Template Id of Npc to be hidden
     * @param hideTemplate
     ...
     *
     * @param npcTemplateId
     *            Template Id of the Npc to be moved
     * @param left
     *            if true, Npc moves to the left. if false, Npc moves to the right
     * @param distance
     *            distance traveled by the Npc
     * @param speed
     *            speed at which the Npc travels (a number between 10 and 300)
     */
     ...
     *
     * @param npcObjId
     *            Object Id of the Npc to be moved
     * @param left
     *            if true, Npc moves to the left. if false, Npc moves to the right
     * @param distance
     *            distance traveled by the Npc
     ...
     *
     * @param npcTemplateId
     *            Template Id of the Npc to be flipped
     * @param left
     *            if true, Npc will face left. if false, Npc will face right
     */
     ...
     *
     * @param npcObjId
     *            Object Id of the Npc to be flipped
     * @param left
     *            if true, Npc will face left. if false, Npc will face right
     */
     ...
     *
     * @param npcTemplateId
     *            Template Id of the Npc to do the Special Action
     * @param effectName
     *            Effect name to be shown
     * @param duration
     *            if duration > 0. The Effect will repeat for duration (ms)
     */
     ...
     *
     * @param npcObjId
     *            Object Id of the Npc to do the Special Action
     * @param effectName
     *            Effect name to be shown
     * @param duration
     *            if duration > 0. The Effect will repeat for duration (ms)
     ...
     * Lower = Zoom Out
     *
     * @param inZoomDuration
     *            Time the Zooming takes
     * @param scale
     *            Zoom Scale
     * @param x
     *            x Position
     ...
     *            method to be ran
     * @param args
     *            arguments used in the specified method
     */
     ...
     *
     * @param left
     *            Direction the player moves in. True = Left. False = Right
     * @param distance
     *            Distance to move
     */
     ...
     *
     * @param left
     *            True = flip Left. False = flip Right
     */
     ...
     *
     * @param type
     *            The Action Done, depending on Type
     * @param duration
     *            The duration the action is held
     */
     ...
     *
     * @param type
     *            type of action used. refer to: {@link net.swordie.ms.enums.ForcedInputType}
     */
     ...
     * @param onUser
     *            if true, the effect will follow the player | if false, the effect will stay static
     * @param idk2
     */
     ...
     * 
     * @param seconds
     *            the amount of seconds the stopwatch should start out with
     */
     ...
     * 
     * @param hours
     *            the amount of hours the stopwatch should start out with
     * @param minutes
     *            the amount of minutes the stopwatch should start out with
     * @param seconds
     *            the amount of seconds the stopwatch should start out with
     */
     ...
     */
    ScheduledFuture invokeAtFixedRate(long initialDelay, long delayBetweenExecutions, int executes, String methodName, Object... args);
