    ...
    public static void saveEquips(String dir) {
        ...
        for (Equip equip : getEquips().values()) {
            try (DataOutputStream dataOutputStream = new DataOutputStream(new FileOutputStream(dir + "/" + equip.getItemId() + ".dat"))) {
                ...
                dataOutputStream.writeInt(equip.isTradeAvailable());
            ...
            for (File file : files) {
                ...
                for (Node mainNode : XMLApi.getAllChildren(nodes.get(0))) {
                    ...
                    if (socket != null) {
                        ...
                        switch (ssName) {
                            case "cash":
                                item.setCash(ssVal != 0);
                                break;
                            case "price":
                                item.setPrice(ssVal);
                                break;
                            case "slotMax":
                                item.setSlotMax(ssVal);
                                break;
                            // info not currently interesting. May be interesting in the future.
                            case "icon":
                            case "iconRaw":
                            ...
                            case "skill":
                                break;
                            case "reqSkillLevel":
                                item.setReqSkillLv(ssVal);
                                break;
                            case "masterLevel":
                                item.setMasterLv(ssVal);
                                break;
                            ...
                            case "willEXP":
                                break;
                            case "tradeBlock":
                                item.setTradeBlock(ssVal != 0);
                                break;
                            case "notSale":
                                item.setNotSale(ssVal != 0);
                                break;
                            case "noCursed":
                                item.setNoCursed(ssVal != 0);
                                break;
                            case "noNegative":
                                item.putScrollStat(noNegative, ssVal);
                                break;
                            case "incRandVol":
                                item.putScrollStat(incRandVol, ssVal);
                                break;
                            case "success":
                                item.putScrollStat(success, ssVal);
                                break;
                            case "incSTR":
                                item.putScrollStat(incSTR, ssVal);
                                break;
                            case "incDEX":
                                item.putScrollStat(incDEX, ssVal);
                                break;
                            case "incINT":
                                item.putScrollStat(incINT, ssVal);
                                break;
                            case "incLUK":
                                item.putScrollStat(incLUK, ssVal);
                                break;
                            case "incPAD":
                                item.putScrollStat(incPAD, ssVal);
                                break;
                            case "incMAD":
                                item.putScrollStat(incMAD, ssVal);
                                break;
                            case "incPDD":
                                item.putScrollStat(incPDD, ssVal);
                                break;
                            case "incMDD":
                                item.putScrollStat(incMDD, ssVal);
                                break;
                            case "incEVA":
                                item.putScrollStat(incEVA, ssVal);
                                break;
                            case "incACC":
                                item.putScrollStat(incACC, ssVal);
                                break;
                            case "incPERIOD":
                                item.putScrollStat(incPERIOD, ssVal);
                                break;
                            case "incMHP":
                            case "incMaxHP":
                                item.putScrollStat(incMHP, ssVal);
                                break;
                            case "incMMP":
                            case "incMaxMP":
                                item.putScrollStat(incMMP, ssVal);
                                break;
                            case "incSpeed":
                                item.putScrollStat(incSpeed, ssVal);
                                break;
                            case "incJump":
                                item.putScrollStat(incJump, ssVal);
                                break;
                            case "incReqLevel":
                                item.putScrollStat(incReqLevel, ssVal);
                                break;
                            case "randOption":
                                item.putScrollStat(randOption, ssVal);
                                break;
                            case "randstat":
                            case "randStat":
                                item.putScrollStat(randStat, ssVal);
                                break;
                            case "tuc":
                                item.putScrollStat(tuc, ssVal);
                                break;
                            case "incIUC":
                                item.putScrollStat(incIUC, ssVal);
                                break;
                            case "speed":
                                item.putScrollStat(speed, ssVal);
                                break;
                            case "forceUpgrade":
                                item.putScrollStat(forceUpgrade, ssVal);
                                break;
                            case "cursed":
                                item.putScrollStat(cursed, ssVal);
                                break;
                            case "maxSuperiorEqp":
                                item.putScrollStat(maxSuperiorEqp, ssVal);
                                break;
                            case "reqRUC":
                                item.putScrollStat(reqRUC, ssVal);
                                break;
                            case "bagType":
                                item.setBagType(ssVal);
                                break;
                            case "charmEXP":
                            case "charismaEXP":
                                item.setCharmEXP(ssVal);
                                break;
                            case "senseEXP":
                                item.setSenseEXP(ssVal);
                                break;
                            case "quest":
                                item.setQuest(ssVal != 0);
                                break;
                            case "reqQuestOnProgress":
                                item.setReqQuestOnProgress(ssVal);
                                break;
                            case "notConsume":
                                item.setNotConsume(ssVal != 0);
                                break;
                            case "monsterBook":
                                item.setMonsterBook(ssVal != 0);
                                break;
                            case "mob":
                                item.setMobID(ssVal);
                                break;
                            case "npc":
                                ...
                                break;
                            case "linkedID":
                                item.setLinkedID(ssVal);
                                break;
                            case "reqEquipLevelMax":
                                item.putScrollStat(reqEquipLevelMax, ssVal);
                                break;
                            case "createType":
                                item.putScrollStat(createType, ssVal);
                                break;
                            case "optionType":
                                item.putScrollStat(optionType, ssVal);
                                break;
                            case "grade":
                                item.setGrade(ssVal);
                                break;
                            case "android":
                                item.setAndroid(ssVal);
                                break;
                            case "spec":
                                break;
                            case "recover":
                                item.putScrollStat(recover, ssVal);
                                break;
                            case "boss":
                                item.putScrollStat(boss, ssVal);
                                break;
                            case "ignoreTargetDEF":
                                item.putScrollStat(ignoreTargetDEF, ssVal);
                            case "incSTRr":
                                item.putScrollStat(incSTRr, ssVal);
                                break;
                            case "incDEXr":
                                item.putScrollStat(incDEXr, ssVal);
                                break;
                            case "incINTr":
                                item.putScrollStat(incINTr, ssVal);
                                break;
                            case "incLUKr":
                                item.putScrollStat(incLUKr, ssVal);
                                break;
                            case "reduceCooltime":
                                item.putScrollStat(reduceCooltime, ssVal);
                                break;
                            case "incCriticaldamageMin":
                                item.putScrollStat(incCriticaldamageMin, ssVal);
                                break;
                            case "incCriticaldamageMax":
                                item.putScrollStat(incCriticaldamageMax, ssVal);
                                break;
                            default:
                                if (LOG_UNKS) {
                                    log.warn(String.format("Unknown node: %s, value = %s, itemID = %s", ssName, ssVal, item.getItemId()));
                                }
                        }
