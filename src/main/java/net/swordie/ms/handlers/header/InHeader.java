...
public enum InHeader {
    ...
    EGO_EQUIP_GAUGE_COMPLETE_RETURN(681),
    EGO_EQUIP_CREATE_UPGRADE_ITEM(682),// v202.6
    EGO_EQUIP_CREATE_UPGRADE_ITEM_COST_REQUEST(683),
    EGO_EQUIP_TALK_REQUEST(684),
    EGO_EQUIP_CHECK_UPDATE_ITEM_REQUEST(685),
    INHERITANCE_INFO_REQUEST(686),
    INHERITANCE_UPGRADE_REQUEST(687),
    MIRROR_READING_SELECT_BOOK_REQUEST(688),
    LIKE_POINT(689),
    USER10TH_STREAMING_URL_REQUEST(690),
    USER_UPDATE_MAPLE_TV_SHOW_TIME(691),
    REDUCE_DOT_DAMGE_BASE_BUFF_REQUEST(692),
    MIRROR_STUDY_COMPLETE(693),
    REQUEST_ARROW_PLATTER_OBJ(694),// was 605
    USER_TIME_EVENT_UI_OPEN_REQUEST(695),
    USER_TIME_EVENT_RESULT_REQUEST(696),
    USER_TIME_EVENT_COMPLETE_REQUEST(697),// was 608
    USER_TIME_EVENT_PASSED_TIME_SET(698),
    INVASION_SETTING_REQUEST(699),
    USER_FIELD_ATTACK_OBJ_REQUEST_BOARDING(700),
    USER_FIELD_ATTACK_OBJ_REQUEST_GET_OFF(701),
    MONSTER_BATTLE(702),
    BOSS_ARENA_MATCH_REQUEST(703),
    BOSS_ARENA_MIGRATE_REQUEST(704),
    MOB_USER_CONTROL_SKILL_Q_PUSH(705),
    MOB_USER_CONTROL_SKILL_Q_POP(706),
    MOB_USER_CONTROL_SKILL_FORCED_Q_POP(707),
    PARTY_QUEST_RANKING_REQUEST(708),
    ATTENDANCE_EVENT(709),
    ATTENDANCE_EVENT_REWARD_REQ(710),
    UI_ATTENDANCE_GHOST_CHANGE_REQ(711),
    EVENT_UI_REQ(712),
    ATTENDANCE_EVENT_SELECT_REWARD(713),
    USER_SET_CUSTOMIZE_EFFECT(714),
    USER_CUSTOMIZE_EFFECT_ITEM_MODIFY(715),
    USER_GROWTH_HELPER_REQUEST(716),
    USER_CONTENTS_MAP_REQUEST(717),
    USER_TIMER_REQ(718),
    USER_MANNEQUIN(719),
    USER_BUFFER_FLY_REQ(720),
    UNK_721(721),
    UNK_722(722),
    UNK_723(723),
    USER_NON_TARGET_FORCE_ATOM_ATTACK(724),
    USER_RUN_SCRIPT(725),
    CHECK_BOSS_PARTY_BY_SCRIPT(726),
    SET_GO_TO_SHINE_CITY_WAIT_FIELD(727),
    SET_STARPLANET_MINI_GAME_CUSTOMIZING_OPTION(728),
    STAR_PLANET_TREND_SHOP_SET_AVATAR(729),
    STAR_PLANET_TREND_SHOP_RESTORE_AVATAR(730),
    STAR_PLANET_REQUEST(731),
    STAR_PLANET_MATCHING_REENTRANCE(732),
    STAR_PLANET_RESULT_UI_EXIT_SCRIPT(733),
    MOVE_TO_URUS_WAITING_FIELD(734),
    MONSTER_COLLECTION_COMPLETE_REWARD_REQ(735),
    MONSTER_COLLECTION_EXPLORE_REQ(736),
    PLAT_FORMAR_ENTER_REQUEST(737),
    UNK_737(738),
    STIGMA_DELEVERY_REQUEST(739),
    ...
    CREATE_KINESIS_PSYCHIC_AREA(806),
    ...
    FAMILIAR_MOVE(967),
    FAMILIAR_UNK969(969), // after attack
    FAMILIAR_UNK970(970), // once after spawn and when changing maps - probably some ack
    FAMILIAR_ATTACK(620),
    FAMILIAR_SKILL(621),
    UNK865(865),
    // Beast Tamer
    ...
    // v203.2
    B_E_G_I_N__M_O_B(1004),
    MOB_MOVE(1005),
    MOB_APPLY_CTRL(1006),
    MOB_DROP_PICK_UP_REQUEST(1007),
    MOB_HIT_BY_OBSTACLE(1008),
    MOB_HIT_BY_OBSTACLE_ATOM(1009),
    MOB_HIT_BY_MOB(1010),
    MOB_SELF_DESTRUCT(1011),
    MOB_SELF_DESTRUCT_COLLISION_GROUP(1012),
    MOB_UNK_1012(1013),
    MOB_ATTACK_MOB(1014),
    MOB_SKILL_DELAY_END(1015),// v203.3
    MOB_TIME_BOMB_END(1016),
    MOB_ESCORT_COLLISION(1017),
    MOB_REQUEST_ESCORT_INFO(1018),
    MOB_ESCORT_STOP_END_REQUEST(1019),
    MOB_AREA_ATTACK_DISEASE(1020),
    MOB_UNK_1020(1021),
    MOB_EXPLOSION_START(1022),
    MOB_LIFTING_END(1023),
    MOB_UPDATE_FIXED_MOVE_DIR(1024),
    MOB_CREATE_FIRE_WALK(1025),
    MOB_AFTER_DEAD_REQUEST(1026),
    MOB_DAMAGE_SHARE_INFO(1027),
    MOB_CREATE_AFFECTED_AREA(1028),
    MOB_DOWN_RESPONSE(1029),// v203.2
    MOB_UNK_1027(1030),
    MOB_UNK_1028(1031),
    MOB_UNK_1030(1032),
    MOB_UNK_1032(1033),
    ...
    // v203.2
    B_E_G_I_N__N_P_C(1039),
    NPC_MOVE(1040),
    NPC_SPECIAL_ACTION(1041),
    E_N_D__N_P_C(1042),
    E_N_D__L_I_F_E_P_O_O_L(1043),

    // v203.2
    B_E_G_I_N__D_R_O_P_P_O_O_L(1044),
    DROP_PICK_UP_REQUEST(1045),
    E_N_D__D_R_O_P_P_O_O_L(1046),

    B_E_G_I_N__R_E_A_C_T_O_R_P_O_O_L(1047),
    REACTOR_HIT(1048),
    REACTOR_CLICK(1049),
    REACTOR_RECT_IN_MOB(1050),
    REACTOR_KEY(1051),
    E_N_D__R_E_A_C_T_O_R_P_O_O_L(1052),
    // todo
    // v203.2
    ...
    B_E_G_I_N__P_A_R_T_Y__M_A_T_C_H(1090),
    INVITE_PARTY_MATCH(1091),
    CANCEL_INVITE_PARTY_MATCH(1092),
    PARTY_MEMBER_CANDIDATE_REQUEST(1093),
    URUS_PARTY_MEMBER_CANDIDATE_REQUEST(1094),
    PARTY_CANDIDATE_REQUEST(1095),
    INTRUSION_FRIEND_CANDIDATE_REQUEST(1096),
    INTRUSION_LOBBY_CANDIDATE_REQUEST(1097),
    END_PARTY_MATCH(1098),
    REQUEST_FOOT_HOLD_MOVE(1099),
    GATHER_REQUEST(1106), // probably wrong just swapped it with rune
    GATHER_END_NOTICE(1101),
    ACT_CHANGE_REACTOR_USE_REQUST(1102),
    USER_ANTI_MACRO_BOMB_REQUEST(1103),
    MAKE_ENTER_FIELD_PACKET_FOR_QUICK_MOVE(1104),
    RUNE_STONE_USE_REQ(1105),
    RUNE_STONE_SKILL_REQ(1100),
    OBTACLE_ATOM_COLLISION(1107),
    TIMER_GAUGE_TIMEOUT(1108),
    FALLING_CATCHER_HACK_CHECK(1109),
    COOK_GAME_REQUEST(1110),
    FPS_MODE_EXIT_REQUEST(1111),
    MAKE_ENTER_FIELD_PACKET_FOR_MIRROR_DUNGEON(1112),
    LEAVE_MIRROR_DUNGEON(1113),
    UNK1113(1114),
    UNK1114(1115),
    UNK1115(1116),
    UNK1116(1117),
    ...
    GOLD_HAMMER_REQUEST(1383), // was 1054
    GOLD_HAMMER_COMPLETE(1384), // was 1055
    E_N_D__I_T_E_M_U_P_G_R_A_D_E(1385),

    // v203.2
    B_E_G_I_N__B_A_T_T_L_E_R_E_C_O_R_D(1388),
    BATTLE_RECORD_ON_OFF_REQUEST(1389),
    BATTLE_RECORD_SKILL_DAMAGE_LOG(1390),
    E_N_D__B_A_T_T_L_E_R_E_C_O_R_D(1393),

    B_E_G_I_N__F_A_R_M(1394),
    UNK1391(1395),
    BUY_FARM_OBJECT(1396),
    SEL_FARM_OBJECT(1397),
    FARM_ADMIN_COMMAND(1398),
    REQUEST_QUEST_COMPLETE(1399),
    CHECK_FARM_NAME(1400),
    REQUEST_INTERACT_OBJECT(1401),
    REQUEST_CONSUME_OBJECT(1402),
    REQUEST_CLICK_NPC(1403),
    REQUEST_RANDOM_FARM(1404),
    INSERT_FARM_OBJECT(1405),
    DELETE_FARM_OBJECT(1406),
    INSERT_FARM_TILE(1407),
    DELETE_FARM_TILE(1408),
    TRANSFER_FARM_FIELD(1409),
    MY_HOUSE_UPGRADE(1410),
    REQUEST_FARM_VISIT(1411),// v203.2
    REQUEST_ADD_FARM_FRIEND(1412),// v203.2
    ...
    static {
        for (InHeader ih : values()) {
            final short ihValue = ih.getValue();
            if (!opToHeaderMap.containsKey(ihValue)) {
