...
public class UserRemote {
    ...
    public static OutPacket attack(Char chr, AttackInfo ai) {
        ...
        if (attackType == OutHeader.REMOTE_SHOOT_ATTACK && (SkillConstants.getAdvancedCountHyperSkill(ai.skillId) != 0 || SkillConstants.getAdvancedAttackCountHyperSkill(ai.skillId) != 0 || SkillConstants.isShikigamiHauntingSkill(ai.skillId))) {
        ...
        if (ai.attackAction <= 1895) {
            ...
            } else if (SkillConstants.isSuperNovaSkill(ai.skillId) || SkillConstants.isScreenCenterAttackSkill(ai.skillId) || ai.skillId == 101000202 || ai.skillId == 101000102 || SkillConstants.isSupportAttackSkill(ai.skillId) || ai.skillId == 400041019 || ai.skillId == 400031016 || ai.skillId == 400041024 || SkillConstants.isWingedJavelin(ai.skillId) || ai.skillId == 400021075 || ai.skillId == 80002452 || ai.skillId == 80001762) {
            ...
            if (ai.skillId == 21120019 || ai.skillId == 37121052 || SkillConstants.isShadowAssault(ai.skillId) || ai.skillId == 11121014 || ai.skillId == 5101004) {
    ...
    public static OutPacket throwGrenade(int charID, int grenadeID, Position pos, int keyDown, int skillID, int bySummonedID, int slv, boolean left, int attackSpeed) {
